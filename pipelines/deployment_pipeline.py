...
def deployment_trigger(
    ...
    """
    Implements a simple model deployment trigger that looka at the input model accuracy and 
    decided if it is good enough to deploy or not.
    """
    return accuracy >= config.min_accuracy

class MLFlowDeploymentLoaderStepParameters(BaseParameters):
    """
    MLFlow deployment getter parameter
    ...
    Attributes:
        ...
        step_name: the name of the step that deployed the MLFlow prediction
            server
        running: when the flag is set, the step only returns a running service
